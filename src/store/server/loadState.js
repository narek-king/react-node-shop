...
const PRODUCT_FIELDS =
	'path,id,name,category_id,category_ids,category_name,sku,images,image,image_2,thumbnail,enabled,discontinued,stock_status,stock_quantity,price,on_sale,price,attributes,tags,position';
