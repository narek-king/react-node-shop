...
class SettingsService {
	constructor() {
		this.defaultSettings = {
			...
			product_fields:
				'path,id,name,category_id,category_name,sku,images,image,image_2,thumbnail,enabled,discontinued,stock_status,stock_quantity,price,on_sale,price,attributes,tags,position',
			products_limit: 30,
			weight_unit: 'kg',
			length_unit: 'cm',
