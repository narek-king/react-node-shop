...
export default class CustomProducts extends React.Component {
	...
	fetchProducts = ({
		...
		const filter = {
			...
			sort,
			fields:
				'path,id,name,category_id,category_name,sku,images,image,image_2,thumbnail,enabled,discontinued,stock_status,stock_quantity,price,on_sale,price,attributes,tags',
			limit: limit || 4,
			offset: 0
		};
